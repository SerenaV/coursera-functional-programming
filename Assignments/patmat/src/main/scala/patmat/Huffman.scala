...
object Main extends App {
  ...
  val tree1 = Fork(Fork(Leaf('a',2), Leaf('b',3), List('a','b'), 5), Leaf('d',4), List('a','b','d'), 9)
  val encoding1 = encode(tree1)(string2Chars("abd"))
  println( encoding1 )
  println( quickEncode(tree1)(string2Chars("abd")) )
